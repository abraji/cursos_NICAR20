# Amostra como você pode fazer o download de arquivos direto no R
# source é página de download
# download primeiro tem o link exato do arquivo
# e depois o local e o nome onde você quer salvar
